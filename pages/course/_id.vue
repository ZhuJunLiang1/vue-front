  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <section class="path-wrap txtOf hLh30">
        ...
        \
        <a href="#" title class="c-999 fsize14">{{course.subjectLevelTwo}}</a>
        \
      ...
      <div>
        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15" style="height : 357px">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in chapter.children" :key="video.id">
                                <a :href="'/player/'+video.videoSourceId" :title="video.title" target="_blank">
                                  <span class="fr" v-if="Number(video.isFree) == 1" >
    ...
    <div class="mt50 commentHtml"><div>
        ...
        <ul>
          <li class="unBr">
            <aside class="noter-pic">
              <img width="50" height="50" class="picImg"  :src="this.loginInfo.avatar" >
              </aside>
            <div class="of">
      ...
      <section class="">
          <section class="question-list lh-bj-list pr">
            <ul class="pr10">
              <li v-for="(comment,index) in this.data.items"  v-bind:key="index">
                  <aside class="noter-pic">
...
export default {
  ...
  methods : {
    ...
    showInfo() {
      ...
      getCourseInfoById() {
          this,courseApi.getCrouseInfo(this.$route.params.id)
            .then(response => {
                this.course = response.data.data.courseWeb,
                this.chapterList = response.data.data.chapterList
                this.isBuy = response.data.data.isBuy
            })
      },
      initPageComment() {
        commentApi.getPageComment(this.page,this.limit,this.courseId).then(response => {
      ...
      gotoPage(page) {
        commentApi.getPageComment(page,this.limit,this.courseId).then(response => {
            this.data = response.data.data
        })
      },
      createOrders() {  
