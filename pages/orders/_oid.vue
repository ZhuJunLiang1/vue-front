    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          ...
          <label for="Agree"><p class="on"><input type="checkbox" checked="checked">我已阅读并同意<a href="javascript:" target="_blank">《芳华学院课程购买协议》</a></p></label>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
          <div class="fl">
...
export default {
  ...
  methods : {
      getOrderInfoById() {
          this,orderApi.getOrderInfo(this.$route.params.oid)
            .then(response => {
