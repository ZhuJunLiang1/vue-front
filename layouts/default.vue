  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        <h1 id="logo">
          <a href="#" title="芳华学院">
            <img src="~/assets/img/logo.png" width="100%" alt="芳华学院">
          </a>
        </h1>
        <div class="h-r-nsl">
          <ul class="nav">
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>服务热线：0371-000000</span>
                <span>Email：zhujunliang0831@163.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2020课程版权均归芳华学院所有 豫ICP备17055252号</span>
              </section>
            </section>
          </section>
